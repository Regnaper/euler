def num_to_words(number)
  ...
  str_number.each_with_index do |num, index|
    ...
    if (index == 2 && num != "0")
      sum_of_letters += $letters_in_num[num] + 7
      sum_of_letters += 3 if number % 100 != 0
    end
...
def main(limit)
  $letters_in_num = {"0" => 0, "1" => 3, "2" => 3, "3" => 5, "4" => 4, "5" => 4, "6" => 3, "7" => 5,"8" => 5, "9" => 4, "10" => 3, "11" => 6, "12" => 6, "13" => 8, "15" => 7, "18" => 8, "20" => 6, "30" => 6, "40" => 5, "50" => 5, "60" => 5, "70" => 7, "80" => 6, "90" => 6,"1000" => 8}
